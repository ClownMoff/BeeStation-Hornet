...
/obj/item/clothing/suit/toggle/caprobe
	name = "Captains's Robe"
	desc = "A captain's fine robe to protect them from cold after a shower."
	icon = 'icons/obj/clothing/suits/wintercoat.dmi'
	worn_icon = 'icons/mob/clothing/suits/wintercoat.dmi'
	icon_state = "captain_robe"
	item_state = "captain_robe"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
